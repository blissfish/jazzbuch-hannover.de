		...
		<div class="container">
			...
			<div class="row placeholders">
				...
				<p>Das erste North Sea Jazz Festival fand im Jahr 1976 in Den
					...
					eher bescheiden. Dennoch traten Jazzgrößen wie Sarah Vaughan, Count
				...
				<p>Zu einer international bedeutenden Jazzveranstaltung ist das
					...
					rd. 9.000 auf rd. 65.000 in dem ab 2006 neuen und großzügigen
				...
				<p>Einen bunten Reigen von unterschiedlichen Musikrichtungen
					...
					New Orleans Jazz, Swing, Bop, Free Jazz, Fusion, Avantgarde-Jazz
					und elektronischem Jazz. Aber auch Blues, Gospel, Funk, Soul, R &
					B, Hip Hop, World Beat, Latin Music bis hin zur Pop-Musik ist alles
					vertreten.</p>
				<p>Neben bekannten Namen wie Nat Adderley, Erykah Badu, Ornette
					...
					Plattform, um in der Öffentlichkeit bekannt zu werden.</p>
